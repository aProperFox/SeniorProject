...
public final class MyTextureManager {

	private static TextureManager tm;
	private static Context context;
	
	public MyTextureManager(Context context){
	...
	public Texture getTexture(String name){
		if(tm.containsTexture(name)){
			...
			tm.addTexture(name, new Texture(BitmapHelper.convert(context.getResources().getDrawable(
				context.getResources().getIdentifier(name.toLowerCase(), "drawable", context.getPackageName()))), true));
			return tm.getTexture(name);
		}
	}
